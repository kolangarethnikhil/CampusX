...
const boards: Board[] = [
  { icon: "briefcase", title: "Internships", description: "Leads & referrals", posts: 24, accent: "#8b5cf6" },
  { icon: "homeRent", title: "Housing", description: "PGs & roommates", posts: 18, accent: "#f59e0b" },
  { icon: "moneyBag", title: "Part-time", description: "Flexible work", posts: 12, accent: "#22c55e" },
  { icon: "laptop", title: "Dev Club", description: "Code & projects", posts: 31, accent: "#3b82f6" },
  { icon: "football", title: "Sports", description: "Games & events", posts: 15, accent: "#06b6d4" },
  { icon: "networking", title: "Social", description: "Hangouts & parties", posts: 9, accent: "#ec4899" },
];
...
export default function BoardsScreen({ onOpenBoard }: BoardsScreenProps) {
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="relative pt-14 px-5 pb-5 bg-gradient-radial">
        ...
        <div className="relative">
          <Search size={15} className="absolute left-4 top-1/2 -translate-y-1/2 text-cx-text-muted" />
          <input
            type="text"
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{ background: `linear-gradient(90deg, transparent, ${board.accent}, transparent)` }}
                />
                ...
                <div className="relative flex flex-col h-full">
                  ...
                  <p className="text-cx-text-muted text-[11px] mb-3">{board.description}</p>
                  <span
