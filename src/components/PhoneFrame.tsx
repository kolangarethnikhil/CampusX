...
export default function PhoneFrame({ children }: PhoneFrameProps) {
  return (
    <div className="min-h-[100dvh] overflow-hidden bg-[#020203] text-cx-text">
      {/* Real mobile / PWA view: no fake phone frame, no dynamic island */}
      <div className="real-mobile-shell mx-auto flex h-[100dvh] w-full max-w-[430px] flex-col overflow-hidden bg-cx-bg md:hidden">
        {children}
      </div>

      {/* Laptop / desktop preview: keep phone frame and dynamic island */}
      <div className="desktop-phone-preview relative hidden min-h-screen items-center justify-center overflow-hidden bg-[#020203] p-6 md:flex">
